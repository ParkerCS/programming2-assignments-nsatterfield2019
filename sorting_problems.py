...
def selection_sort(list):
    iterations_bigloop = 0
    iterations_smallloop = 0
    for cur_pos in range(len(list)):
        iterations_bigloop += 1
        min_pos = cur_pos
        for scan_pos in range(cur_pos + 1, len(list)):
            if list[scan_pos] < list[min_pos]:
                min_pos = scan_pos
                iterations_smallloop += 1
        list[min_pos], list[cur_pos] = list[cur_pos], list[min_pos]
    return list, iterations_bigloop, iterations_smallloop



sort_selection = selection_sort(sort_me)
print("New List:", sort_selection[0])
...
sort_insertion = insertion_sort(sort_me2)
print("New List:", sort_insertion[0])
...
sort = selection_sort(sort_me3)
print("New List #3 - Selection Sort:" , sort[0])
print("New List #3 - SS - Big Loop:", sort[1])
print("New List #3 - SS - Small Loop:", sort[2])

sort = insertion_sort(sort_me3)
print("New List #3 - Insertion Sort:" , sort[0])
print("New List #3 - IS - Big Loop:", sort[1])
print("New List #3 - IS - Small Loop:", sort[2])
...
sort = selection_sort(sort_me4)
print("New List #4 - Selection Sort:" , sort[0])
print("New List #4 - SS - Big Loop:", sort[1])
print("New List #4 - SS - Small Loop:", sort[2])

sort = insertion_sort(sort_me4)
print("New List #4 - Insertion Sort:" , sort[0])
